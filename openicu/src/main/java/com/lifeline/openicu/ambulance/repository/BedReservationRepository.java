...
public interface BedReservationRepository extends JpaRepository<BedReservation, UUID> {
    ...
    /**
     * Find active reservations by bed ID (may return multiple if duplicates exist)
     */
    List<BedReservation> findByBedIdAndStatus(Long bedId, ReservationStatus status);
